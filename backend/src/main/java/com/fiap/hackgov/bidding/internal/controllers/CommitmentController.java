...
public class CommitmentController {
    ...
    public ResponseEntity<PageResponseDTO<CommitmentResponseDTO>> findByContractId(
    ...
    public ResponseEntity<PageResponseDTO<CommitmentResponseDTO>> findByExecutionOrderId(
            @PathVariable UUID executionOrderId,
            @PageableDefault(page = 0, size = 10, sort = "createdAt", direction = Sort.Direction.DESC) Pageable pageable
    ) {
