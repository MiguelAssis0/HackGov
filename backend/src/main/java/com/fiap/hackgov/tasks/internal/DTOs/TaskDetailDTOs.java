...
public final class TaskDetailDTOs {
    ...
    public record CommentResponse(UUID id, String text, UUID authorId, String authorName, LocalDateTime createdAt,
                                  LocalDateTime editedAt) {
    }

    public record ChecklistResponse(UUID id, String title, int orderIndex, boolean completed, UUID completedById,
                                    String completedByName, LocalDateTime completedAt) {
    }

    public record TimeResponse(UUID id, UUID employeeId, String employeeName, LocalDateTime startedAt,
                               LocalDateTime finishedAt,
                               long durationSeconds, boolean active, boolean manual, LocalDate referenceDate,
                               String observation) {
    }

    public record AttachmentResponse(UUID id, String originalName, String contentType, long size, UUID uploadedById,
                                     String uploadedByName, LocalDateTime createdAt) {
    }
